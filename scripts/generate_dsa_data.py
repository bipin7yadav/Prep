...
print(f"Total Curated High-Frequency Interview Problems: {len(DSA_PROBLEMS)}")

with open("/home/bipin/Desktop/BankInterview/frontend/src/data/dsaPracticeData.js", "w") as f:
...
print("✓ Successfully written to frontend/src/data/dsaPracticeData.js")
